...
class Command(BaseCommand):
    help = "Crear un tenant Binn, provisionar su schema y asignar admin opcional."
    ...
    def handle(self, *args, **options):
        ...
        record_tenant_event(
            ...
            title="Tenant creado por comando",
            message="Se provisiono el tenant desde bootstrap_tenant.",
            code="tenant_created_cli",
        )
        self.stdout.write(self.style.SUCCESS(f"Tenant {result.client.schema_name} creado."))
