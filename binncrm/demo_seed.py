    ...
    entities = [
        _entity_payload(
            ...
            extra={
                ...
                "service_line": "consultoria" if profile == PROFILE_SERVICIOS else "",
                "service_stage": "cliente_activo" if profile == PROFILE_SERVICIOS else "",
                "account_health": "expansion" if profile == PROFILE_SERVICIOS else "",
                "started_on": str(timezone.localdate() - timedelta(days=90)) if profile == PROFILE_SERVICIOS else "",
        ...
        _entity_payload(
            ...
            extra={
                ...
                "service_line": "implementacion" if profile == PROFILE_SERVICIOS else "",
                "service_stage": "prospecto" if profile == PROFILE_SERVICIOS else "",
                "account_health": "seguimiento" if profile == PROFILE_SERVICIOS else "",
        ...
        _entity_payload(
            ...
            extra={
                ...
                "service_line": "automatizacion" if profile == PROFILE_SERVICIOS else "",
                "service_stage": "prospecto" if profile == PROFILE_SERVICIOS else "",
                "account_health": "seguimiento" if profile == PROFILE_SERVICIOS else "",
            },
        ),
        _entity_payload(
            ...
            extra={
                ...
                "service_line": "capacitacion" if profile == PROFILE_SERVICIOS else "",
                "service_stage": "renovacion_upsell" if profile == PROFILE_SERVICIOS else "",
                "account_health": "expansion" if profile == PROFILE_SERVICIOS else "",
                "started_on": str(timezone.localdate() - timedelta(days=150)) if profile == PROFILE_SERVICIOS else "",
        ...
        _entity_payload(
            ...
            extra={
                ...
                "service_line": "soporte" if profile == PROFILE_SERVICIOS else "",
                "service_stage": "cliente_activo" if profile == PROFILE_SERVICIOS else "",
                "account_health": "estable" if profile == PROFILE_SERVICIOS else "",
                "started_on": str(timezone.localdate() - timedelta(days=210)) if profile == PROFILE_SERVICIOS else "",
...
def _build_condominio_demo(tenant) -> dict:
    entities = [
        _entity_payload(
            ...
            extra={"resident_status": "al_dia", "departamento": "A-204", "torre": "Torre A", "alicuota": 135},
        ),
        _entity_payload(
            tenant,
            key="jorge-mera",
            ...
            extra={"resident_status": "cartera_vencida", "departamento": "B-703", "torre": "Torre B", "alicuota": 165},
        ),
        _entity_payload(
            tenant,
            key="susana-mora",
            ...
            extra={"resident_status": "promesa_pago", "departamento": "C-110", "torre": "Torre C", "alicuota": 148},
        ),
        _entity_payload(
            tenant,
            key="hector-robles",
            ...
            extra={"resident_status": "seguimiento", "departamento": "A-105", "torre": "Torre A", "alicuota": 122},
        ),
    ]
        ...
        "documents": [
            {
                "entity_key": "jorge-mera",
                "deal_key": "deal-jorge",
                "title": "Estado de cuenta abril B-703",
                "document_type": "estado_cuenta",
                "external_url": "https://demo.binn.ec/el_rosal/condominio/estado-cuenta-b703.pdf",
                "metadata": {
                    "periodo": "2026-04",
                    "saldo": 330,
            ...
            },
            {
                "entity_key": "susana-mora",
                "deal_key": "deal-susana",
                "title": "Comprobante transferencia Susana Mora",
                "document_type": "comprobante_pago",
                "external_url": "https://demo.binn.ec/el_rosal/condominio/comprobante-susana.pdf",
                "metadata": {
                    "monto": 148,
            ...
            {
                "entity_key": "adriana-perez",
                "title": "Contrato residente Adriana Perez",
                "document_type": "contrato_residente",
                "external_url": "https://demo.binn.ec/el_rosal/condominio/contrato-adriana.pdf",
                "metadata": {
                    "departamento": "A-204",
    ...
    entities = [
        _entity_payload(
            ...
            extra={
                ...
                "instagram": "@camilaarias",
                "ultima_compra": "2026-04-12",
            },
        ),
        _entity_payload(
            tenant,
            ...
            extra={
                "client_segment": "frecuente",
                "talla": "S",
                "estilo": "Denim",
                "canal_preferido": "instagram",
                "color_favorito": "Azul",
                "instagram": "@sofiaviteri",
                "ultima_compra": "2026-04-05",
            },
        ),
        _entity_payload(
            tenant,
            ...
            extra={
                "client_segment": "ocasional",
                "talla": "L",
                "estilo": "Casual",
                "canal_preferido": "tienda",
                "color_favorito": "Verde",
                "instagram": "@martinloor",
        ...
        _entity_payload(
            ...
            extra={
                "client_segment": "inactiva",
                "talla": "M",
                "estilo": "Basicos",
                "canal_preferido": "whatsapp",
                "color_favorito": "Beige",
                "instagram": "@elena.z",
        ...
        return [
            {
                "object_key": "proyecto",
                "data": {
                    "nombre": "Operacion comercial continua Flores & Co",
                    "cliente": "Flores & Co",
                    "linea_servicio": "Consultoria",
                    "estado": "en_ejecucion",
                    "responsable": "Andrea Leon",
                    "fecha_inicio": str(today - timedelta(days=90)),
                    "fecha_cierre_objetivo": str(today + timedelta(days=45)),
                    "prioridad": "alta",
                },
                "age_days": 4,
            },
            {
                "object_key": "proyecto",
                "data": {
                    "nombre": "Implementacion CRM Distribuidora Andina",
                    "cliente": "Distribuidora Andina",
                    "linea_servicio": "Implementacion",
                    "estado": "kickoff",
                    "responsable": "Mateo Ruiz",
                    "fecha_inicio": str(today - timedelta(days=5)),
                    "fecha_cierre_objetivo": str(today + timedelta(days=60)),
                    "prioridad": "alta",
                },
                "age_days": 2,
            },
            {
                ...
                "data": {
                    ...
                    "cliente": "Flores & Co",
                    "proyecto": "Operacion comercial continua Flores & Co",
                    "tipo_entregable": "Workshop",
                    "estado": "en_curso",
                    "responsable": "Andrea Leon",
                    "prioridad": "alta",
                    "fecha_entrega": str(today + timedelta(days=2)),
                    "fecha_revision": str(today + timedelta(days=4)),
                },
                "age_days": 1,
            },
            {
                ...
                "data": {
                    ...
                    "cliente": "Distribuidora Andina",
                    "proyecto": "Implementacion CRM Distribuidora Andina",
                    "tipo_entregable": "Playbook",
                    "estado": "por_validar",
                    "responsable": "Mateo Ruiz",
                    "prioridad": "media",
                    "fecha_entrega": str(today + timedelta(days=5)),
                    "fecha_revision": str(today + timedelta(days=7)),
                },
                "age_days": 3,
            },
        ]
        ...
        return [
            {
                ...
                "data": {
                    "codigo_unidad": "A-204",
                    "torre": "Torre A",
                    "propietario": "Adriana Perez",
                    "residente_actual": "Adriana Perez",
            ...
            },
            {
                ...
                "data": {
                    "codigo_unidad": "B-703",
                    "torre": "Torre B",
                    "propietario": "Jorge Mera",
                    "residente_actual": "Jorge Mera",
                    "estado_ocupacion": "ocupada",
                    "metros_cuadrados": "82",
                },
                "age_days": 7,
            },
            {
                ...
                "data": {
                    "codigo_unidad": "C-110",
                    "torre": "Torre C",
                    "propietario": "Susana Mora",
                    "residente_actual": "Susana Mora",
                    "estado_ocupacion": "arriendo",
                    "metros_cuadrados": "74",
                },
                "age_days": 3,
            },
            {
                "object_key": "incidencia",
                "data": {
                    "asunto": "Fuga en ducto de Torre B",
                    "codigo_unidad": "B-703",
                    "residente": "Jorge Mera",
                    "tipo": "mantenimiento",
                    "prioridad": "alta",
                    "estado": "en_gestion",
                    "reportada_en": str(today - timedelta(days=2)),
                    "comentario": "Pendiente coordinacion con proveedor para ingreso.",
                },
                "age_days": 2,
            },
            {
                "object_key": "comunicado",
                "data": {
                    "asunto": "Recordatorio de pago abril",
                    "codigo_unidad": "C-110",
                    "dirigido_a": "Susana Mora",
                    "canal": "whatsapp",
                    "estado": "enviado",
                    "fecha_envio": str(today - timedelta(days=1)),
                    "comentario": "Se compartio valor exacto y datos de transferencia.",
                },
                "age_days": 1,
            },
            {
                "object_key": "comunicado",
                "data": {
                    "asunto": "Aviso mantenimiento preventivo Torre A",
                    "codigo_unidad": "A-204",
                    "dirigido_a": "Adriana Perez",
                    "canal": "email",
                    "estado": "confirmado",
                    "fecha_envio": str(today - timedelta(days=5)),
                    "comentario": "Comunicado general de corte de agua programado.",
                },
                "age_days": 5,
            },
            {
                "object_key": "incidencia",
                "data": {
                    "asunto": "Consulta por parqueo visitante",
                    "codigo_unidad": "A-105",
                    "residente": "Hector Robles",
                    "tipo": "convivencia",
                    "prioridad": "baja",
                    "estado": "abierta",
                    "reportada_en": str(today - timedelta(days=1)),
                    "comentario": "Pendiente respuesta de administracion sobre disponibilidad.",
                },
                "age_days": 1,
            },
        ]
        ...
        return [
            {
                "object_key": "wishlist",
                "data": {
                    "cliente": "Sofia Viteri",
                    "pieza": "Blazer crema oversize",
                    "categoria": "Blazers",
                    "talla": "S",
                    "prioridad": "alta",
                    "fecha_followup": str(today + timedelta(days=2)),
                    "vigente": True,
                },
                "age_days": 2,
            },
            {
                ...
                "data": {
                    ...
                    "talla": "S",
                    "prioridad": "media",
                    "fecha_followup": str(today + timedelta(days=7)),
                    "vigente": False,
                },
                "age_days": 8,
            },
            {
                "object_key": "wishlist",
                "data": {
                    "cliente": "Camila Arias",
                    "pieza": "Set sastrero negro",
                    "categoria": "Sets",
                    "talla": "M",
                    "prioridad": "alta",
                    "fecha_followup": str(today + timedelta(days=1)),
                    "vigente": True,
                },
                "age_days": 1,
            },
